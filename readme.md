...
[Solution](/hw008/task002/Program.cs)
...
Необходимо отметить магазины (M), которые нужно закрыть по наименьшему удалению от одного из магазинов при этом M < N.
...
[Solution](/hw009/task002/Program.cs)
...
[Solution](/hw009/task003/Program.cs)